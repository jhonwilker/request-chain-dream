    ...
    Tables: {
      api_requests: {
        Row: {
          ...
          variables_to_extract: Json | null
        }
        Insert: {
          body?: string | null
          created_at?: string
        ...
        Relationships: [
          {
            foreignKeyName: "api_requests_test_suite_id_fkey"
      ...
      request_results: {
        ...
        Relationships: [
          {
            foreignKeyName: "request_results_api_request_id_fkey"
          ...
          {
            foreignKeyName: "request_results_execution_id_fkey"
